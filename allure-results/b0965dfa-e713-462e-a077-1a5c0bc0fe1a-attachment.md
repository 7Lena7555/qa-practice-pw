...
```
Error: locator.click: Error: strict mode violation: locator('//a[@class="nav-link router-link-exact-active active"]') resolved to 2 elements:
    1) <a href="/" class="nav-link router-link-exact-active active">↵          Home↵        </a> aka getByRole('link', { name: 'Home' })
    2) <a href="/" class="nav-link router-link-exact-active active">↵                Global Feed↵              </a> aka getByRole('link', { name: 'Global Feed' })

Call log:
  - waiting for locator('//a[@class="nav-link router-link-exact-active active"]')

    at C:\Users\Lena\OneDrive\Documents\qa-practice-pw\tests\conduit\login.spec.ts:6:78
```
...
>  6 | await page.locator('//a[@class="nav-link router-link-exact-active active"]').click();
     |                                                                              ^ Error: locator.click: Error: strict mode violation: locator('//a[@class="nav-link router-link-exact-active active"]') resolved to 2 elements:
