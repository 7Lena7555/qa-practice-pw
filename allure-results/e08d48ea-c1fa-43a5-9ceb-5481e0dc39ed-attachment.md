...
Call log:
  - waiting for locator('xpath=(//li[contains(@class, "rct-node") and .//span[@class="rct-title" and normalize-space(text())="Desktop"]]//button[@aria-label="Toggle"])[1]')

    at C:\Users\Lena\OneDrive\Documents\qa-practice-pw\tests\demoqa\text-box.spec.ts:35:165
```
...
```ts
  ...
  33 |
  34 |   // 
> 35 |   await page.locator('(//li[contains(@class, "rct-node") and .//span[@class="rct-title" and normalize-space(text())="Desktop"]]//button[@aria-label="Toggle"])[1]').click();
     |                                                                                                                                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  36 |
