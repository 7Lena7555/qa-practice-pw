...
```
Error: locator.waitFor: Error: strict mode violation: getByRole('link', { name: 'testuser' }) resolved to 10 elements:
...
Call log:
  - waiting for getByRole('link', { name: 'testuser' }) to be visible

    at C:\Users\Lena\OneDrive\Documents\qa-practice-pw\tests\conduit\follow-user.spec.ts:17:21
```
