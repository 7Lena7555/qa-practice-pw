...
Call log:
  - waiting for locator('//ul[@class=\'menu-list\']/li[@id=\'item-1\']/span[@class=\'text\' and text()=\'Radio Button\']')

    at C:\Users\Lena\OneDrive\Documents\qa-practice-pw\tests\demoqa\elements-x-path.spec.ts:42:113
```
...
> 42 |   await page.locator(`//ul[@class='menu-list']/li[@id='item-1']/span[@class='text' and text()='Radio Button']`).click();
     |                                                                                                                 ^ Error: locator.click: Test timeout of 30000ms exceeded.
