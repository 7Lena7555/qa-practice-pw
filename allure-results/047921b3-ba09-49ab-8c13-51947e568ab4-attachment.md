...
Call log:
  - waiting for locator('xpath=(//li[contains(concat(" ", normalize-space(@class), " "), " rct-node ") and .//span[@class="rct-title" and text()="Desktop"]]//button[@aria-label="Toggle"])[1]')

    at C:\Users\Lena\OneDrive\Documents\qa-practice-pw\tests\demoqa\text-box.spec.ts:34:185
```
...
```ts
  ...
  33 |
> 34 |   await page.locator('(//li[contains(concat(" ", normalize-space(@class), " "), " rct-node ") and .//span[@class="rct-title" and text()="Desktop"]]//button[@aria-label="Toggle"])[1]').click();
     |                                                                                                                                                                                         ^ Error: locator.click: Test timeout of 30000ms exceeded.
  35 |
