...
Call log:
  - waiting for locator('xpath=(//li[contains(@class, "rct-node") and .//span[@class="rct-title" and text()="Desktop"]]//button[@aria-label="Toggle"])[1]')
...
```ts
  ...
  33 |
> 34 |   await page.locator('(//li[contains(@class, "rct-node") and .//span[@class="rct-title" and text()="Desktop"]]//button[@aria-label="Toggle"])[1]').click();
     |                                                                                                                                                    ^ Error: locator.click: Test timeout of 30000ms exceeded.
  35 |   
